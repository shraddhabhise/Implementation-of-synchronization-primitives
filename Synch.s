...
_CheckVersion_P_Synch_:
	...
	set	0xdb66e29c,r4		! myHashVal = -614014308
	cmp	r3,r4
	be	_Label_9
	set	_CVMess1,r1
	call	_putString
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if IsAcquired != _P_Thread_currentThread then goto _Label_56		(int)
	load	[r14+8],r1
	load	[r1+4],r1
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if IsAcquired == 0 then goto _Label_61		(int)
	load	[r14+8],r1
	load	[r1+4],r1
	mov	0,r2
	cmp	r1,r2
...
! ASSIGNMENT STATEMENT...
	mov	112,r13		! source line 112
	mov	"\0\0AS",r10
!   IsAcquired = _P_Thread_currentThread		(4 bytes)
	set	_P_Thread_currentThread,r1
	load	[r1],r1
	load	[r14+8],r2
	store	r1,[r2+4]
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if IsAcquired == _P_Thread_currentThread then goto _Label_72		(int)
	load	[r14+8],r1
	load	[r1+4],r1
	set	_P_Thread_currentThread,r2
	load	[r2],r2
...
! RETURN STATEMENT...
	...
	mov	"\0\0RE",r10
!   if IsAcquired != _P_Thread_currentThread then goto _Label_90		(int)
	load	[r14+8],r1
	load	[r1+4],r1
	set	_P_Thread_currentThread,r2
	load	[r2],r2
...
!   Send message IsHeldByCurrentThread
	...
	add	r2,16,r2
	call	r2
!   Retrieve Result: targetName=_temp_103  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-9]
!   if _temp_103 then goto _Label_102 else goto _Label_101
	loadb	[r14+-9],r1
	cmp	r1,0
	be	_Label_101
	jmp	_Label_102
...
!   Send message IsHeldByCurrentThread
	...
	add	r2,16,r2
	call	r2
!   Retrieve Result: targetName=_temp_115  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-9]
!   if _temp_115 then goto _Label_114 else goto _Label_113
	loadb	[r14+-9],r1
	cmp	r1,0
	be	_Label_113
	jmp	_Label_114
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if t == 0 then goto _Label_119		(int)
	load	[r14+-36],r1
	mov	0,r2
	cmp	r1,r2
	be	_Label_119
...
!   _temp_120 = t + 76
	...
	add	r1,76,r1
	store	r1,[r14+-20]
!   Data Move: *_temp_120 = 2  (sizeInBytes=4)
	mov	2,r1
	load	[r14+-20],r2
	store	r1,[r2]
! SEND STATEMENT...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (t) then goto _Label_140
	load	[r14+-36],r1
	cmp	r1,r0
	be	_Label_140
	jmp	_Label_141
...
!   _temp_142 = t + 76
	...
	add	r1,76,r1
	store	r1,[r14+-20]
!   Data Move: *_temp_142 = 2  (sizeInBytes=4)
	mov	2,r1
	load	[r14+-20],r2
	store	r1,[r2]
! SEND STATEMENT...
