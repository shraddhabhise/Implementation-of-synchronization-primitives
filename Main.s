...
! Make sure _P_Thread_ has hash value 0xd98e6cc5 (decimal -644977467)
	...
	cmp	r1,0
	bne	_Label_59
! Make sure _P_Synch_ has hash value 0xdb66e29c (decimal -614014308)
	set	_packageName,r2
	set	0xdb66e29c,r3
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_313 = &_Global_BufferNextOutLock
	set	_Global_BufferNextOutLock,r1
	store	r1,[r14+-224]
!   Send message Init
	load	[r14+-224],r1
	load	[r1],r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_314 = &_Global_BufferNextInLock
	set	_Global_BufferNextInLock,r1
	store	r1,[r14+-220]
!   Send message Init
	load	[r14+-220],r1
	load	[r1],r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_316 = &_Global_Semaphore_fullbuffs
	set	_Global_Semaphore_fullbuffs,r1
	store	r1,[r14+-212]
!   Prepare Argument: offset=12  value=_Global_full_buffs  sizeInBytes=4
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_317 = &_Global_Semaphore_emptybuffs
	set	_Global_Semaphore_emptybuffs,r1
	store	r1,[r14+-208]
!   Prepare Argument: offset=12  value=_Global_empty_buffs  sizeInBytes=4
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_430 = &_Global_Semaphore_emptybuffs
	set	_Global_Semaphore_emptybuffs,r1
	store	r1,[r14+-48]
!   Send message Down
	load	[r14+-48],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_431 = &_Global_BufferNextInLock
	set	_Global_BufferNextInLock,r1
	store	r1,[r14+-44]
!   Send message Lock
	load	[r14+-44],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_437 = &_Global_Semaphore_fullbuffs
	set	_Global_Semaphore_fullbuffs,r1
	store	r1,[r14+-20]
!   Send message Up
	load	[r14+-20],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_438 = &_Global_BufferNextInLock
	set	_Global_BufferNextInLock,r1
	store	r1,[r14+-16]
!   Send message Unlock
	load	[r14+-16],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_459 = &_Global_Semaphore_fullbuffs
	set	_Global_Semaphore_fullbuffs,r1
	store	r1,[r14+-48]
!   Send message Down
	load	[r14+-48],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_460 = &_Global_BufferNextOutLock
	set	_Global_BufferNextOutLock,r1
	store	r1,[r14+-44]
!   Send message Lock
	load	[r14+-44],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_466 = &_Global_Semaphore_emptybuffs
	set	_Global_Semaphore_emptybuffs,r1
	store	r1,[r14+-20]
!   Send message Up
	load	[r14+-20],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_467 = &_Global_BufferNextOutLock
	set	_Global_BufferNextOutLock,r1
	store	r1,[r14+-16]
!   Send message Unlock
	load	[r14+-16],r1
...
_P_Main_ForkMonitor:
	...
	jmp	_Method_P_Main_ForkMonitor_4	! 12:	Test
	jmp	_Method_P_Main_ForkMonitor_3	! 16:	PutDownForks
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: mutexLock = zeros  (sizeInBytes=20)
	load	[r14+8],r4
	add	r4,28,r4
	store	r0,[r4]
	store	r0,[r4+4]
...
!   Data Move: _temp_661 = *_temp_663  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-36]
!   if _temp_661 == 2 then goto _Label_660		(int)
	load	[r14+-36],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_660
...
!   _temp_684 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-48]
!   Move address of _temp_684 [p ] into _temp_685
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-44]
!   Data Move: *_temp_685 = 3  (sizeInBytes=4)
	mov	3,r1
	load	[r14+-44],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   Data Move: _temp_713 = *_temp_715  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-84]
!   if _temp_713 != 1 then goto _Label_710		(int)
	load	[r14+-84],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_710
...
!   _temp_718 = _temp_719 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-64]
!   Move address of _temp_717 [_temp_718 ] into _temp_720
!     make sure index expr is >= 0
	load	[r14+-64],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-56]
!   Data Move: _temp_716 = *_temp_720  (sizeInBytes=4)
	load	[r14+-56],r1
	load	[r1],r1
	store	r1,[r14+-72]
!   if _temp_716 == 2 then goto _Label_710		(int)
	load	[r14+-72],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_710
...
!   _temp_723 = _temp_724 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-44]
!   Move address of _temp_722 [_temp_723 ] into _temp_725
!     make sure index expr is >= 0
	load	[r14+-44],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_721 = *_temp_725  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-52]
!   if _temp_721 == 2 then goto _Label_710		(int)
	load	[r14+-52],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_710
...
!   _temp_726 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-32]
!   Move address of _temp_726 [p ] into _temp_727
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   Data Move: *_temp_727 = 2  (sizeInBytes=4)
	mov	2,r1
	load	[r14+-28],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   _temp_729 = &mutexLock
	...
	add	r1,28,r1
	store	r1,[r14+-20]
!   _temp_730 = &SignalEating
	load	[r14+8],r1
	add	r1,48,r1
	store	r1,[r14+-16]
!   Move address of _temp_730 [p ] into _temp_731
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_759 = 4		(4 bytes)
	...
	store	r1,[r14+-36]
!   Initialize FOR-LOOP index variable
!   Data Move: p = _temp_758  (sizeInBytes=4)
	load	[r14+-40],r1
	store	r1,[r14+-44]
_Label_754:
!   Perform the FOR-LOOP termination test
!   if p > _temp_759 then goto _Label_757		
	load	[r14+-44],r1
	load	[r14+-36],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-24]
!   Data Move: _temp_765 = *_temp_767  (sizeInBytes=4)
	load	[r14+-24],r1
	load	[r1],r1
	store	r1,[r14+-32]
